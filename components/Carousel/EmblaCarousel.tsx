...
const EmblaCarousel = () => {
  ...
  components.push(
    <Image
      classNames={{
        wrapper:
          "bg-white dark:bg-card min-w-full rounded-xl border-dashed border border-gray-400 dark:border-none",
      }}
  ...
  components.push(
    <AppleMusic className="border-dashed border border-gray-400 dark:border-none" />
  );
