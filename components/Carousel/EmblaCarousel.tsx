...
const EmblaCarousel = () => {
  ...
  components.push(
    <Image
      classNames={{
        wrapper: "bg-white dark:bg-card min-w-full rounded-xl border-dashed border dark:border-0",
      }}
  ...
  components.push(<AppleMusic className="border-dashed border dark:border-0"/>);
