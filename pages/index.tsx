          ...
          <div className="page">
            <div className={"content"}>
              <ScrollShadow
                ...
                visibility="bottom"
                className="grid gap-y-4 md:gap-y-2 scroll-smooth h-dvh md:max-h-[50rem] rounded-xl mx-1 mb-1 md:mb-2 border-dashed border-gray-300"
              >
                <section>
                  <Image
                    rel="preload"
                ...
                <section>
                  <Box>
                    ...
                    <Divider className={"my-4"} />
                    <Recommendation className="mb-10"/>
                  </Box>
                </section>
