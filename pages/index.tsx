...
const Home: NextPage = ({ images }: { images: ImageProps[] }) => {
  ...
  return (
    <>
      ...
      > */}
        <div
          className="bg-blur backdrop-blur-xl fixed top-[env(safe-area-top)] w-full h-svh z-[999] border border-red-500 "
          ref={nodeRef}
        >
          <JackeyLoveLogo
            size={300}
            className="absolute dark:brightness-150 w-[40%] md:w-[30%] lg:w-[20%] m-auto"
          />
        </div>
      {/* </CSSTransition> */}
    </>
